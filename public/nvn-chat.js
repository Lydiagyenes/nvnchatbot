...
(function() {
  ...
  NVNChatWidget.prototype._injectStyles = function() {
    ...
    style.textContent = [
      ...
      // Strong CSS reset - exclude SVG and its children so icons remain visible
      "#nvn-chat-widget, #nvn-chat-widget *:not(svg):not(svg *), #nvn-chat-widget *::before, #nvn-chat-widget *::after { all: revert; box-sizing: border-box !important; }",
      "#nvn-chat-widget svg { display:inline-block !important; vertical-align:middle !important; overflow:visible !important; }",
